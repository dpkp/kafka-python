...
from kafka.protocol.old.api import RequestHeader
from kafka.protocol.old.fetch import FetchRequest
from kafka.protocol.old.metadata import MetadataRequest
