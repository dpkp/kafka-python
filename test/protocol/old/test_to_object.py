from kafka.protocol.old.api import Request
from kafka.protocol.old.api import Response
from kafka.protocol.old.types import Schema, Array, Int16, String
...
def test_with_metadata_response():
    from kafka.protocol.old.metadata import MetadataResponse_v5
