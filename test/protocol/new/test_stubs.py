...
from kafka.protocol.new.generate_stubs import (
    MESSAGE_MODULES,
    discover_modules,
    generate_module,
    resolve_type,
...
class TestResolveType:
    def test_simple_int(self):
        from kafka.protocol.new.consumer.group import HeartbeatRequest
    ...
    def test_struct_array(self):
        from kafka.protocol.new.consumer.fetch import FetchRequest
...
class TestGenerateModule:
    def test_generates_imports(self):
        from kafka.protocol.new.consumer import group
        mod = group
        ...
        assert 'from kafka.protocol.new.api_message import ApiMessage' in content
    ...
    def test_stubs_up_to_date(self):
        ...
        for mod_file, (mod, exports) in modules.items():
            ...
            if not os.path.exists(pyi_path):
                pytest.skip('Stubs not generated yet — run: python -m kafka.protocol.new.generate_stubs')
            content = generate_module(mod, exports)
