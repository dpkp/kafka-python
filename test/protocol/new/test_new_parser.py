    ...
    'messages': (
        ...
        },
        {
            ...
            'response': (
                ...
                3,
                MetadataResponse[8](throttle_time_ms=0, brokers=[(0, 'localhost', 47485, None)], cluster_id='34wjNp3hRJixCRvMlK9Znw', controller_id=0, topics=[], cluster_authorized_operations=-2147483648),
            ),
        },
        {
            'request': (
