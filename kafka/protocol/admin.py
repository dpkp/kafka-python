...
class CreateTopicsResponse_v3(Response):
    API_KEY = 19
    API_VERSION = 3
    SCHEMA = CreateTopicsResponse_v3.SCHEMA
...
CreateTopicsResponse = [
    ...
    CreateTopicsResponse_v2, CreateTopicsRequest_v3,
]
...
class SaslAuthenticateRequest_v1(Request):
    ...
    SCHEMA = SaslAuthenticationRequest_v0.SCHEMA
...
class CreatePartitionsResponse_v1(Response):
    API_KEY = 37
    API_VERSION = 1
    SCHEMA = CreatePartitionsResponse_v1.SCHEMA
...
class CreatePartitionsRequest_v1(Request):
    API_KEY = 37
    API_VERSION = 1
    SCHEMA = CreatePartitionsReques_v1.SCHEMA
